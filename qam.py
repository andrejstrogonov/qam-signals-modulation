...
class Qam:
    ...
    def __init__(self,
            ...
            carrier_freq = 100):
        """
        Создайте модулятор, используя OOK по умолчанию
        """
    ...
    def generate_signal(self, data):
        """
        Сгенерируйте сигнал, соответствующий текущей схеме модуляции, чтобы
        представляют заданную двоичную строку, данные.
        """
    ...
    def plot_constellation(self):
        """
        Постройте диаграмму сигнального созвездия, представляющую схему модуляции.
        """
